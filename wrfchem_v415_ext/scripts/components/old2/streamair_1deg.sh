...
remapped_dir=$basdir/data/output-wrf-remapped1deg
data_back_remapped_dir=$basdir/data_back/output-wrf-remapped1deg
...
cdo remapbil,mygrid1deg d01_timestamped d01_reg
...
python $run_dir/earthjsonfromwrf_uv_1deg.py d01_reg2 .
mv 9999-wind-surface-level-gfs-1.0.json $dir_out/${dateid}:00-wind-10m-wrf-chem-3.5_1deg.json
find d* -type f -not -name d01_reg -delete
# 
