...
ecmwf_path='/mnt/raid/wrf-chem/ECMWF-op'
...
print(os.path.islink(link_dest))
...
#here, copy the file from the leapyear backup directory to the working directory

copyfile(os.path.join(emis_preproc_dir,'leapyearfile/wrfchemi_d01_2020-02-29_00:00:00'), os.path.join(emis_preproc_dir,'wrfchemi_d01_2020-02-29_00:00:00'))
