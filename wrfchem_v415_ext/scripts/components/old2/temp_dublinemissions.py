...
for n in range(st,en):
    ...
    #dayemisname12=('wrfchemi_d01_2020-02-29_00:00:00')
    #orig_emis_fname=os.path.join(emis_preproc_dir, dayemisname)
    #enh_emis_fname=os.path.join(emis_preproc_dir, dayemisname12)
    #ds=Dataset(enh_emis_fname, 'r+')
    #for hi in range(0,24):
        #print(hi)
        #print(ds.variables['Times'][0,1])
        #print(ds.variables['Times'].shape)
        #ds.variables['Times'][hi,9]=b'9'
        #print(ds.variables['Times'][:])
