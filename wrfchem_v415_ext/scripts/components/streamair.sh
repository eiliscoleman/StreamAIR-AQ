...
# cdo selvar,COSALPHA wrfout_org cosalpha
# cdo selvar,SINALPHA wrfout_org sinalpha
...
# echo $dir_out
# echo $dateid
 python $run_dir/produce_merc_plots_jsons2.py d01_reg $runhrdir $dir_out $dateid
...
# #organics json
#        echo  "org25"
#        cdo selvar,org25 d01_surf d01_surf_org25
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_org25 d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . org25
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-org25-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
#        
# #sulphate json
#        echo  "sulf25"
#        cdo selvar,sulf25 d01_surf d01_surf_sulf25
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_sulf25 d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . sulf25
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-sulf25-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
# #nitrate json
#        echo  "nitr25"
#        cdo selvar,nitr25 d01_surf d01_surf_nitr25
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_nitr25 d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . nitr25
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-nitr25-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
# # #nh425 json
#        echo  "nh425"
#        cdo selvar,nh425 d01_surf d01_surf_nh425
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_nh425 d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . nh425
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-nh425-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
# #cl25 json
#        echo  "cl25"
#        cdo selvar,cl25 d01_surf d01_surf_cl25
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_cl25 d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . cl25
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-cl25-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
# #BC json
#        echo  "BC"
#        cdo selvar,bc d01_surf d01_surf_bc
#        ncrename -O -v lon,XLONG -v lat,XLAT -v time,Times d01_surf_bc d01_reg1
#        ncpdq -O -h -a -lat d01_reg1 d01_reg2
#        python $run_dir/touchpoint_aerosols.py d01_reg2 . bc
# #       mv 9999-pm25-surface-level-gfs-1.0.json $dir_out/$datestr-pm25-lev$levstr-wrf-chem-3.5.json
#        mv 9999-aerosol.json $dir_out/${dateid}:00-bc-wrf-chem-3.5.json
#        find d* -type f -not -name d01_surf  -not -name d01_reg -delete 
#        
#        
#        
...
#      printf -v levstr "%02d" $lev
#        echo  "cldfraction"
#        cdo sellevel,5 d01_reg d01_lev5
#        
#        cdo selvar,cldfra d01_lev5 d01_lev5_cldfra
# 
#        cdo sellevel,6 d01_reg d01_lev6
#        cdo selvar,cldfra d01_lev6 d01_lev6_cldfra
#        
#        cdo sellevel,7 d01_reg d01_lev7
#        cdo selvar,cldfra d01_lev7 d01_lev7_cldfra
#        
#        cdo sellevel,8 d01_reg d01_lev8
#        cdo selvar,cldfra d01_lev8 d01_lev8_cldfra
#        
#        cdo sellevel,9 d01_reg d01_lev9
#        cdo selvar,cldfra d01_lev9 d01_lev9_cldfra
#        
#        cdo sellevel,10 d01_reg d01_lev10
#        cdo selvar,cldfra d01_lev10 d01_lev10_cldfra
#        
#        cdo sellevel,11 d01_reg d01_lev11
#        cdo selvar,cldfra d01_lev11 d01_lev11_cldfra
#        
#        cdo max d01_lev5_cldfra d01_lev6_cldfra d01_lev56_cldfra
#        cdo max d01_lev56_cldfra d01_lev7_cldfra d01_lev567_cldfra
#        cdo max  d01_lev567_cldfra d01_lev8_cldfra d01_lev5678_cldfra
#        cdo max  d01_lev5678_cldfra d01_lev9_cldfra d01_lev56789_cldfra
#        cdo max  d01_lev56789_cldfra d01_lev10_cldfra d01_lev5678910_cldfra
#        cdo max  d01_lev5678910_cldfra d01_lev11_cldfra d01_lev_cldfra
#        
