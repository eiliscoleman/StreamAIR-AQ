...
#cmap.set_under('w')
cmap=LinearSegmentedColormap.from_list('palette', palette, N=len(palette))
...
cbar_png_out_path=(png_out_dir+'/snow_cbar_gnuplot2.png')
...
cbar.ax.text( ( (3.7 )) / (divfac), .5, '0.5', ha='center', va='center', weight='bold', color="black", fontsize="20", fontweight="bold")
cbar.ax.text( ( (2.8 )) / (divfac), .5, '0.3', ha='center', va='center', weight='bold', color="black", fontsize="20", fontweight="bold")
cbar.ax.text( ( (1.5 )) / (divfac), .5, '0.1', ha='center', va='center', weight='bold', color="black", fontsize="20", fontweight="bold")
#ax1.patch.set_visible(False)
cbar.outline.set_visible(False)
ax2=fig.add_axes([0.0001, 0.05, 0.15, 0.85])
#Rectange((x,y, width, height))
ax2.add_patch(patches.Rectangle((0.00001, 0.0001), 0.9999, 0.9999, color='white', linewidth='0', label='None') )
ax2.annotate('   Snow mm', (0.001, 0.45),  color='k', weight='bold', fontsize=20)
...
#ax2.annotate('           -1', (0.9, 0.6),  color='k', weight='bold', fontsize=12)
