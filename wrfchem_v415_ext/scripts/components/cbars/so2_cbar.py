...
cbar_png_out_path=(png_out_dir+'/so2_cbar.png')
...
#Rectange((x,y, width, height))
ax2.add_patch(patches.Rectangle((0.00001, 0.0001), 0.9999, 0.9999, color='black', linewidth='0', label='None') )
ax2.annotate(' SO   ppb', (0.01, 0.45),  color='white', weight='bold', fontsize=20)
ax2.annotate(' 2', (0.35, 0.4),  color='white', weight='bold', fontsize=14)
...
cbar.ax.text( ( (10 + 0.7)) / (divfac), .5, '12.0', ha='center', va='center', weight='bold', color="black", fontsize="20", fontweight="bold")
cbar.ax.text( ( (9 + 0.7)) / (divfac), .5, '6.0', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (8 + 0.7)) / (divfac), .5, '3.0', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (7 + 0.6)) / (divfac), .5, '2.0', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (6 + 0.6)) / (divfac), .5, '1.0', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (5 + 0.5)) / (divfac), .5, '0.7', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (4 + 0.5)) / (divfac), .5, '0.5', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (3 + 0.5)) / (divfac), .5, '0.3', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (2 + 0.5)) / (divfac), .5, '0.2', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (1 + 0.5)) / (divfac), .5, '0.1', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
cbar.ax.text( ( (0 + 0.5)) / (divfac), .5, '0.0', ha='center', va='center', weight='bold', color="white", fontsize="20", fontweight="bold")
#ax2=fig.add_axes([0.0001, 0.05, 0.15, 0.85])
##Rectange((x,y, width, height))
#ax2.add_patch(patches.Rectangle((0.00001, 0.0001), 0.9999, 0.9999, color='black', linewidth='0', label='None') )
