...
cbar_png_out_path=(png_out_dir+'/t2_cbar.png')
...
ax2.annotate('Temperature C', (0.01, 0.45),  color='white', weight='bold', fontsize=16)
...
for j, lab in enumerate(cbarticks):
    if j<6:
        cbar.ax.text( ( (j + 0.05)) / (divfac), .5, lab, ha='left', va='center', color="white", fontsize=18, fontweight="bold")
cbar.ax.text( ( (2 + 0.05)) / (divfac), .5, "0", ha='left', va='center', color="blue", fontsize=18, fontweight="bold")    
