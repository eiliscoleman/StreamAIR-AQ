...
curl --upload-file "../imgs/{pm25-ir,pm25-eu,rain-ir,rain-e,t2-p-ir,t2-p-e,wind-ir,wind-e,rh-ir,rh-e}.gif" --user f112266:head+mace+FPT ftp://www.macehead.org/webspace/siteapps/5379/htdocs/images/stories/
