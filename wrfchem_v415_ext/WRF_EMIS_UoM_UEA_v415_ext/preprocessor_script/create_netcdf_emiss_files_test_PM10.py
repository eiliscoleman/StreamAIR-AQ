...
dataset = ds('/mnt/raid/wrf-chem/emis/WRF_EMIS_UoM_UEA/preprocessor_script/OUT/PM10_tno_out.nc','w','r', format='NETCDF4_CLASSIC') #output file
...
#print dataset.file_format # At UEA the TNO emissions preprocessor program pm10mpiles/runs, only, with the netCDF3.6.3 library. I am not able to produce a netcd3 file directly since is an old library. Therefore, I have applied the following pm10nversion
